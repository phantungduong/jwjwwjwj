...
def fetch_proxies():
    url_list =[
        "https://api.proxyscrape.com/v3/free-proxy-list/get?request=getproxies&protocol=http&timeout=9950&proxy_format=ipport&format=text",
        "https://raw.githubusercontent.com/sarperavci/freeCheckedHttpProxies/main/freshHttpProxies.txt",
